							...
							<div className="flex flex-col gap-4 text-center sm:text-left">
								...
								<div className="text-white hidden sm:flex gap-5 justify-between ">
									<div
										onClick={() => {
											(setStakebutton("25"),
												setStakevalue({...stakevalue,stakeInput:((25 / 100) * data.wallet)}))
										}}
									...
									<div
										onClick={() => {
											(setStakebutton("50"),
												setStakevalue({...stakevalue,stakeInput:((50 / 100) * data.wallet)}))
										}}
										onMouseOut={() => setStakebutton(false)}
									...
									<div
										onClick={() => {
											(setStakebutton("75"),
												setStakevalue({...stakevalue,stakeInput:((75 / 100) * data.wallet)}))
										}}
										onMouseOut={() => setStakebutton(false)}
									...
									<div
										onClick={() => {
											(setStakebutton("MAX"), setStakevalue({...stakevalue,stakeInput:data.wallet}));
										}}
										onMouseOut={() => setStakebutton(false)}
